package com.ethioware.knowit.Attempt_Quiz_Section;
...
import com.example.knowit.NotificationActivity.NotificationService;
import com.example.knowit.R;
import com.example.knowit.Model.Question;
import com.example.knowit.Model.Test;
...
//            next.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
    ...
    class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.r1.setText(data.get(holder.getAdapterPosition()).getOpt_A());
